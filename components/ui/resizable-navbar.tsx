  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        visible && "bg-background/80 backdrop-blur-lg border border-border",
        className,
      )}
    >
      {children}
  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        visible && "bg-background border border-border",
        className,
      )}
    >
      {children}
    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          exit={{ opacity: 0 }}
          className={cn(
            "absolute inset-x-0 top-16 z-50 flex w-full flex-col items-start justify-start gap-4 rounded-xl bg-background border border-border px-4 py-8 shadow-lg",
            className,
          )}
        >
          {children}
...
export const NavbarButton = ({
  ...
  const variantStyles = {
    ...
    secondary: "bg-transparent shadow-none text-foreground border border-border hover:bg-muted",
